    ...
    <>
      ...
      <form className="container mt-5">
        ...
        <div className="d-flex justify-content-around">
          <button type="submit" className="btn btn-secondary btn-lg active" onClick={handleSubmit}>Login</button>
          <button className="btn btn-primary btn-lg active" onClick={navigateToRegister}>Create an account </button>
        </div>
      </form>
    </>
